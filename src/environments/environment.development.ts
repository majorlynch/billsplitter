export const environment = {
    ...
    apiKeyDeepSeek: process.env["API_KEY_DEEPSEEK"],
    firebaseConfig: {
        apiKey: "AIzaSyBdgIkui4VLwWui6bdimqyyIcKAx-nt3mE",
        authDomain: "cl-angular-training.firebaseapp.com",
        databaseURL: "https://cl-angular-training-default-rtdb.europe-west1.firebasedatabase.app",
    ...
    reCaptchaKey: '6LdUf1orAAAAABGZnIRCF3Q11ReAa7XLREFFKpoe'
